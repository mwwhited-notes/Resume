...
- **Medical Device Software Development:** Backend communication and synchronization software development for the company's medical device systems using WPF, .NET 4.8, SQLite, and WiX installer technologies
...
- **Application Rescue Project:** Inherited application in "horrible, hardly functioning state" from failed offshore development team - now primary contributor to combined codebase
...
- **Competitive Analysis & Innovation:** Evaluated an internal RAG chat product's limitations, created superior hybrid search engine combining vector embeddings with BM25/full text search for faster, cheaper, more accurate data recovery
